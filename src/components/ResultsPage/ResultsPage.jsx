...
const ResultsPage = ({ answers }) => {
  ...
  const userLevel = levels[answers[0]] || "Fitness Enthusiast";

  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <h1 className="text-3xl font-bold text-gray-800 text-center mb-6">
        Your FitCoach Plan: {userLevel}
      </h1>
      ...
      {/* CTA Button */}
      <button className="mt-8 bg-green-600 text-white font-bold text-lg py-4 px-8 rounded-full hover:bg-green-700 transition active:scale-95">
